...
[account_asset_low_value](account_asset_low_value/) | 16.0.1.0.0 | [![kittiu](https://github.com/kittiu.png?size=30px)](https://github.com/kittiu) | Assets Management - Low Value Asset
...
[account_cash_deposit](account_cash_deposit/) | 16.0.1.2.1 |  | Manage cash deposits and cash orders
...
[account_chart_update_multilang](account_chart_update_multilang/) | 16.0.1.0.3 | [![edlopen](https://github.com/edlopen.png?size=30px)](https://github.com/edlopen) [![rafaelbn](https://github.com/rafaelbn.png?size=30px)](https://github.com/rafaelbn) | Update tax and fiscal position templates with multilang
...
[account_loan](account_loan/) | 16.0.1.0.6 | [![etobella](https://github.com/etobella.png?size=30px)](https://github.com/etobella) | Account Loan management
...
[account_usability](account_usability/) | 16.0.1.1.0 | [![legalsylvain](https://github.com/legalsylvain.png?size=30px)](https://github.com/legalsylvain) | Adds missing menu entries for Account module and adds the option to enable Saxon Accounting
