...
[account_asset_management](account_asset_management/) | 18.0.1.0.4 |  | Assets Management
...
[account_chart_update](account_chart_update/) | 18.0.1.1.4 |  | Wizard to update a company's account chart from a template
...
[account_loan](account_loan/) | 18.0.1.0.0 | <a href='https://github.com/etobella'><img src='https://github.com/etobella.png' width='32' height='32' style='border-radius:50%;' alt='etobella'/></a> | Account Loan management
